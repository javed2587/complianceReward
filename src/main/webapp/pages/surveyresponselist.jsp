    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="content" class="clearfix">
                ...
                <form:form action="add" commandName="surveyResponse">
                    ...
                    <div class="page-message messageheading" style="padding-top:3px;">  
                        ...
                        <c:if test="${sessionBean.pmap[(30).intValue()].manage eq true}">

                            <div style="margin-top: 1px;" class="btndrop addbtn" onclick="location.href = '${pageContext.request.contextPath}/surveyResponse/add'">

                                <a class="btn_Color" href="${pageContext.request.contextPath}/surveyResponse/add">Add New</a>&nbsp;&nbsp;<span class="plusCol"><i class="fa fa-plus"></i></span>
                                    ...
                                    <table class="display" id="example" class="display table">
                                        ...
                                        <thead>
                                            ...
                                            <tr class="row grid-header">
                                                ...
                                                <th class="col-lg-8 col-md-8 col-sm-8 col-xs-8 hidden-xs">

                                                    <span class="tbl_f">Response(s)</span>
                                        ...
                                        <tbody>
                                            ...
                                            <c:forEach var="list" items="${surveyResponselist}">

                                                <tr class="row grid-row">

                                                    <td class="col-lg-3 col-md-3 col-sm-3 col-xs-10">

                                                        <span id="tbl_textalign">${list.title}</span>

                                                    </td>

                                                    <td class="col-lg-8 col-md-8 col-sm-8 col-xs-8 hidden-xs">

                                                        <c:forEach var="valid" items="${list.surveyResponseDetails}" varStatus="validLoop">

                                                            <span id="tbl_textalign">${valid.title}<c:if test="${!validLoop.last}">,</c:if></span>   

                                                        </c:forEach>

                                                    </td>

                                                    <td class="col-lg-1 col-md-1 col-sm-1 col-xs-2 text-right text-left-ipad padd-left-16-ipad" style="text-align: center;">

                                                        <span id="tbl_textalign">

                                                             <a class="${sessionBean.pmap[(30).intValue()].manage eq true?'':'disabled'}" href="${pageContext.request.contextPath}/surveyResponse/edit/${list.id}"><img src="${pageContext.request.contextPath}/resources/images/edit.jpg" width="20"/></a>

                                                             <a class="${sessionBean.pmap[(30).intValue()].manage eq true?'':'disabled'}" href="#" onclick="isDeleteRecord('surveyResponse/delete/${list.id}')"><img src="${pageContext.request.contextPath}/resources/images/delete.jpg" width="20"/></a>
