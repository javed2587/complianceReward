                ...
                <div class="customTableRow clearfix cutome_left">
                    ...
                    <div class="tque_left">
                        ...
                        <div class="rxqueue" style="background-color:#3582b3">
                            <p class="caretRight"> <a style="color:#fff;" href="${pageContext.request.contextPath}/PharmacyPortal/newMemberRequest/?status=">RX QUEUE </a></p>
                        </div>
                        ...
                        <div class="rxqueue" style="background-color:#8aca14">
                            <p class="caretRight"> <a href="${pageContext.request.contextPath}/PharmacyPortal/patientActivities">PATIENT ACTIVITIES </a> </p>
                        </div>
                        <div class="rxqueue" style="background-color:#8aca14">
                        ...
                        <div class="tableContainer">
                            ...
                            <div class="tab-content">
                                ...
                                <table  id="example" class="display" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        <c:forEach var="row" items="${patientActivitiesList}">
                                            <tr>
                                                <td id="patientId" value="${row.patientId}">${row.firstName}</td>
                                                <td id="patientAge">${row.birth}</td>
                                                <td id="date">${row.dateTime}</td>
                                                <td id="patientBloodPressureDetail" class="btn" onclick="window.patientActivity.getPatientBloodPressureDetails();"><a href="/ComplianceRewards/PharmacyPortal/bloodPressureDetails">${row.bloodPressure}</a></td>
                                                <!--<td>${row.bloodPressure}</td>-->
                                                <td>${row.glucoseLevel}</td>
                                                <td>${row.bodyMass}</td>
...
<div id="patientActivityDetails" class="medicationModal confirmation_modal listModal healthModal formModal modal fade" role="dialog">
    <div class="modal-dialog" style="top:15% !important; width: 850px !important">
        <!-- Modal content-->
        <div class="modal-content" style="width: 850px !important">
            <div class="modal-header">
                ...
                <h4  class="modal-title"><label id="patientActivityDetailHeading"></label></h4> 

            </div>
            <div class="modal-body">
                    <div>
                        
                        <div class="patient-activity-sub-details"> <label>Date: </label> <label id="detailSubHDate"></label> </div>
                        <div class="patient-activity-sub-details"> <label>Patient Name: </label> <label id="detailSubHName" style="color:#1F72B7"></label> </div>
                        <div class="patient-activity-sub-details"> <label>Age: </label> <label id="detailSubHAge"></label> </div>
                        <br />
                        <div class="patient-activity-sub-details-div-table">
                            <table>
                                <thead style="background-color: #CCCCCC; color: #3A3A3A">
                                    <tr>
                                        <th id="patientActivityDetailsTableHeadCol1" style="width:20%; border-top-left-radius: 10px;"></th>
                                        <th id="patientActivityDetailsTableHeadCol2" style="border-top-right-radius: 10px;"></th>
                                    </tr>
                                </thead>
                                <tbody id="patientActivityDetailsTableBody">
                                    <c:forEach var="row" items="${patientBloodPressureList}">
                                        <tr>
                                            <td>${row.systolicBloodPressure}/${row.distolicBloodPressure}</td>
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/portal/patientActivitySubDetails.css" />
        <script>
...
//                                                                console.log("Key "+key+" VAL "+value);
        ...
        <script type="text/javascript" charset="utf-8" src="${pageContext.request.contextPath}/resources/ssasoft/js/patientActivity.js"></script>
    </body>
</html>
