...
public class PracticesDTO {
    ...
    private String practiceAvialable;
    private Integer sessionStatus;
    private int sessionId;
    private String createdAt;
    private String physicainImage;
    private List<String> majorSpecialization;
    private List<String> subSpecialization;
    private List<String> physicainLanguages;
    ...
    public String getPhysicainImage() {
        return physicainImage;
    }

    public void setPhysicainImage(String physicainImage) {
        this.physicainImage = physicainImage;
    }


    public String getPracticeAvialable() {
        return practiceAvialable;
    }

    public void setPracticeAvialable(String practiceAvialable) {
        this.practiceAvialable = practiceAvialable;
    }
 ...
 public Long getUserId() {
    ...
    public void setCreatedAt(String createdAt) {
       ...
       public List<String> getMajorSpecialization() {
        return majorSpecialization;
    }

    public void setMajorSpecialization(List<String> majorSpecialization) {
    ...
    public void setSubSpecialization(List<String> subSpecialization) {
        this.subSpecialization = subSpecialization;
    }

    public List<String> getPhysicainLanguages() {
        return physicainLanguages;
    }

    public void setPhysicainLanguages(List<String> physicainLanguages) {
        this.physicainLanguages = physicainLanguages;
    }
