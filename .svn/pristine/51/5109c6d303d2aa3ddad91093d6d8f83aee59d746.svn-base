...
//Unuse table not exist in DB

//@Entity
//@Table(name = "AggregatorMessageRequest")
public class AggregatorMessageRequest implements java.io.Serializable {

    private Integer messageReqNo;
    ...
    public AggregatorMessageRequest() {
    }

    public AggregatorMessageRequest(String phoneNumber, Integer folderId, Integer messageTypeId, Integer campaignId, String fileTypeCode, String messageRequest, String rxGroupNumber, Date cardholderDob, Date fillDate, String ndcNumber, Date effectiveDate, int redemptionId) {
    ...
    public AggregatorMessageRequest(String phoneNumber, Integer folderId, Integer messageTypeId, Integer campaignId, String messageText, String messageContext, String fileTypeCode, String messageRequest, String rxGroupNumber, Date cardholderDob, String fileName, Date fillDate, String ndcNumber, Integer claimStatus, Date effectiveDate, Date endDate, int redemptionId, long intervalId, String intervalDescription,
    ...
    public Integer getMessageReqNo() {
        return this.messageReqNo;
    }

    public void setMessageReqNo(Integer messageReqNo) {
    ...
    @Column(name = "Message_Context", length = 50)
    ...
    @Column(name = "Message_Request", nullable = false, length = 2000)
