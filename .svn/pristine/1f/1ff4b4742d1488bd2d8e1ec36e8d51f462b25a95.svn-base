                ...
                <div class="head_top">
                    <div class="wrapper clearfix">
                        <div class="col-sm-2 logo">
                            <h1><a href="${pageContext.request.contextPath}/PharmacyPortal/newMemberRequest"><img src="${pageContext.request.contextPath}/resources/images/compliance-reward-logo.png" alt="" /></a>
